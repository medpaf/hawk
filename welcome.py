...
def intro1():
    ...
    print(f'{Fore.RED} `///////---::/::-.-:///:-`     .:///:` {Style.RESET_ALL}{Fore.CYAN}License{Style.RESET_ALL}: MIT')
    print(f'{Fore.RED} -/////:--..``` `.---.`      `.::-:/:`  {Style.RESET_ALL}')
    print(f'{Fore.RED} :///:.`..                `.:/:.`-/:`   {Style.RESET_ALL}{Fore.CYAN}Configuration file{Style.RESET_ALL}: files/conf.py') #
    print(f'{Fore.RED} :///` .:.            `.-::-.` `-//-    {Style.RESET_ALL}')
    print(f'{Fore.RED} .//. `....``         -/-`    .:///.    {Style.RESET_ALL}{Fore.BLACK}███{Fore.RED}███{Fore.GREEN}███{Fore.YELLOW}███{Fore.LIGHTBLUE_EX}███{Fore.MAGENTA}███{Fore.CYAN}███{Fore.WHITE}███')
    print(f'{Fore.RED} `:/-:///////:`      `/:`   .:////:`    {Style.RESET_ALL}{Fore.LIGHTBLACK_EX}███{Fore.LIGHTRED_EX}███{Fore.LIGHTGREEN_EX}███{Fore.LIGHTYELLOW_EX}███{Fore.BLUE}███{Fore.LIGHTMAGENTA_EX}███{Fore.LIGHTCYAN_EX}███{Fore.LIGHTWHITE_EX}███')
    print(f'{Fore.RED}  `////////////`    `:/` `-://////`     {Style.RESET_ALL}')
    print(f'{Fore.RED}   `://////////.   `:/--:///////:`      {Style.RESET_ALL}')
    print(f'{Fore.RED}    `-/////////` `.////////////.`       {Style.RESET_ALL}')
    print(f'{Fore.RED}      `.://///.`-://////////:.`         {Style.RESET_ALL}')
