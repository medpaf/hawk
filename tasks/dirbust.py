    ...
    try:
        for line in lines:
            ...
            if(r.status_code != 404):
                print(f'[{Fore.GREEN}+{Style.RESET_ALL}] Discovered directory: http://{Fore.GREEN}{domain}{line}{Style.RESET_ALL} Status code: {Fore.GREEN}{r.status_code}{Style.RESET_ALL}')
